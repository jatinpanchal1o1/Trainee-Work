...
if ( ! defined( 'SM_URL' ) )
define( 'SM_URL', untrailingslashit( plugins_url( basename( untrailingslashit( plugin_dir_path( __FILE__ ) ) ), basename( __FILE__ ) ) ) . '/' );
...
function _sm_available_fields() {
	return apply_filters( 'sm_field_types', array(
		...
		'taxonomy_ajax'		=> 'SM_Taxonomy_Ajax',
		'post_type_ajax'	=> 'SM_Post_Type_Ajax',
