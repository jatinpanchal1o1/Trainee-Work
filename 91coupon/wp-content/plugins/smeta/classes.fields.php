...
class SM_Taxonomy_Ajax extends SM_Field {
	...
	public function html() { 
        ...
        echo '<input data-additional="'.htmlspecialchars( json_encode( $args['additional'] ) ).'" data-post_type="'.esc_attr( $args['post_type'] ).'" data-multiple="'.$multi.'" data-sortable="'.$sortable.'" type="hidden" value="'.esc_attr( $v ).'" data-placeholder="' . $placeholder . '" name="'.$this->get_the_name_attr().'" class="redux-select-item sm-taxonomy-ajax" data-selected="'.esc_html__( $selected ).'"/>';
...
class SM_Post_Type_Ajax extends SM_Field {
	...
	public function html() { 
        ...
        echo '<input data-additional="'.htmlspecialchars( json_encode( $args['additional'] ) ).'" data-post_type="'.esc_attr( $args['post_type'] ).'" data-multiple="'.$multi.'" data-sortable="'.$sortable.'" type="hidden" value="'.esc_attr( $val ).'" data-placeholder="' . $placeholder . '" name="'.$this->get_the_name_attr().'" class="redux-select-item sm-post-type-ajax" data-selected="'.esc_html__( $selected ).'"/>';
