...
if ( ! class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name = 'couponxl_options'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		...
		public function __construct() {
			...
			$this->demo_files_path = COUPONXL_CPT_DIR . '/radium-one-click-demo-install/demo-files/'; //can
