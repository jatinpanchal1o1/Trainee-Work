            ...
            <div class="row">
				<?php if ( $_offer_type == 'deal' ): ?>
                        ...
                        <div class="white-block">
                                ...
                                <div class="white-block-media">
                                    <div class="embed-responsive embed-responsive-16by9">
										...
										if ( ! empty( $deal_images ) ) {
											...
											echo '<img src="' . esc_url( get_template_directory_uri() . '/images/sider-featured-placeholder.png' ) . '" class="embed-responsive-item" />';
										}
										?>
                                    </div>
                                </div>
                            ...
                            <div class="white-block-content">
                                ...
                                <ul class="list-unstyled list-inline top-meta">
									...
									<?php endif; ?>
                                    <li><i class="fa fa-circle"></i><?php echo couponxl_taxonomy( 'offer_cat', 1 ); ?>
                                    </li>
                            ...
                            <div class="white-block author-box">
                                <div class="media">
                                    <div class="media-left">
										...
										?>
                                        <img src="<?php echo esc_url( $avatar_url ) ?>" class="media-object"/>
                                    </div>
                    ...
                    <div class="col-sm-4">
						...
						?>
                        <div class="widget white-block deal-sidebar-box <?php echo isset( $offer_availability ) && $offer_availability ? '' : 'disabled' ?>">
                                    ...
                                    <div class="deal-countdown-info">
                                        ...
                                        <h4>
											...
											if ( $offer_expire <= current_time( 'timestamp' ) ) {
												...
												?>
                                               <?php echo xl_remaining_time( $offer_expire, 'single' ); ?>
												<?php
											}
											?>
                                        </h4>
							...
							if ( $deal_show_bought == 'yes' && empty( $deal_link ) ):
                                ...
                                <div class="deal-bought-wrap">
                                    ...
                                    <div class="deal-bought-info">
                                        <h4> <?php echo esc_html( $deal_vouchers );
											_e( ' Bought!', 'couponxl' ); ?> </h4>
                                    </div>
                                </div>
							<?php endif; ?>
                            ...
                            <ul class="deal-value-wrap list-unstyled list-inline">
								...
								if ( ! empty( $deal_discount ) ):
                                    ...
                                    <li>
                                        ...
                                        <h6><?php echo esc_html( $deal_discount ); ?></h6>
                                    </li>
								<?php endif; ?>
                            ...
                            <ul class="list-unstyled list-inline store-social-networks">
                                ...
                                <li>
                                    <a href="http://twitter.com/intent/tweet?source=<?php echo esc_attr( get_bloginfo( 'name' ) ) ?>&amp;text=<?php echo urlencode( get_permalink() ) ?>"
                                       class="share" target="_blank">
                                ...
                                <li>
                                    <a href="javascript:;" class="share mail-share"
                                       data-body="<?php the_permalink(); ?>" data-subject="<?php the_title(); ?>">
							...
							if ( ! empty( $deal_in_short ) ):
                                ...
                                <div class="white-block-content">
                                    ...
                                    <div class="read-more">
                                        <p><?php echo esc_html( $deal_in_short ); ?></p>
                                    </div>
                                    <a href="javascript:" class="read-more-toggle"
                                       data-close="<?php esc_attr_e( 'Close', 'couponxl' ) ?>"><?php _e( 'Read More', 'couponxl' ) ?></a>
                                </div>
							<?php endif; ?>
                    ...
                    <script type="application/ld+json">
                {
                  ...
                  "aggregateRating": {
                    ...
                    "reviewCount": "<?php echo esc_html( $result['count'] ); ?>"
                  },
                  <?php endif; ?>
                  "offers": {
                    "@type": "Offer",
                    "priceCurrency": "<?php echo esc_attr( couponxl_get_option( 'main_unit_abbr' ) ) ?>",
                    "price": "<?php echo esc_html( $deal_sale_price ); ?>",
                                    ...
                                    <h4>
										...
										if ( ! empty( $offer_start ) && $offer_start > current_time( 'timestamp' ) ) {
                                            ...
                                            <span class="deal-countdown"
                                                  data-single="<?php esc_attr_e( 'Day', 'couponxl' ) ?>"
                                                  data-multiple="<?php esc_attr_e( 'Days', 'couponxl' ) ?>"
                                                  data-expire="<?php echo esc_attr( $countdown_time ) ?>"
                                                  data-current-time="<?php echo esc_attr( current_time( 'timestamp' ) ); ?>"></span>
											<?php
										} else if ( ! empty( $offer_expire ) && $offer_expire == '99999999999' ) {
