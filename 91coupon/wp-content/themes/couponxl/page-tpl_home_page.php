					...
					<?php if ( $home_page_show_title == 'yes' ): ?>
                        <div class="home-page-title">
                            ...
                            <h5>
								...
								echo str_replace( array( '%stores%', '%locations%' ), array(
									$stores,
									$locations
								), couponxl_get_option( 'home_page_subtitle' ) );
								?>
                            </h5>
                        </div>
					<?php endif; ?>
                            ...
                            <form method="get"
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control location-search"
                                               placeholder="<?php echo couponxl_get_option( 'home_page_search_location_placeholder' ) ?>">
                                        <input type="hidden"
                                               name="<?php echo esc_attr( $couponxl_slugs['location'] ) ?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden"
                                               name="<?php echo esc_attr( $couponxl_slugs['offer_store'] ) ?>"
