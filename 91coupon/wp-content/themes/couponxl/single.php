                    ...
                    <div class="white-block">
                        ...
                        <div class="white-block-content blog-item-content">
                            <ul class="list-unstyled list-inline top-meta">
                                <li><i class="fa fa-calendar-o"></i><?php the_time( get_option( 'date_format' ) ) ?>
                                </li>
                                <li><i class="fa fa-user"></i><?php _e( 'By ', 'couponxl' );
									the_author_meta( 'display_name' ); ?></li>
								<?php
								$categories = couponxl_categories_list();
								if ( ! empty( $categories ) ):
									?>
                                    <li><i class="fa fa-bars"></i><?php echo wp_kses_post( $categories ); ?></li>
								<?php
								endif;
								?>
