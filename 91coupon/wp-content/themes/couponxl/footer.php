...
$footer_instagram  = couponxl_get_option( 'footer_instagram' );

if ( ! empty( $footer_copyrights ) || ! empty( $footer_facebook ) || ! empty( $footer_twitter ) || ! empty( $footer_google ) || ! empty( $footer_instagram ) ):
	?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="pull-right">
						...
						if ( ! empty( $footer_instagram ) ) {
							?>
                            <a href="<?php echo esc_url( $footer_instagram ) ?>" class="btn instagram" target="_blank"><i class="fa fa-instagram"></i></a>
							<?php
						}
						?>
                    </div>
