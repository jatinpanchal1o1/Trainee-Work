            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="white-block">
						...
						?>
						<?php if ( ! empty( $store_facebook ) || ! empty( $store_twitter ) || ! empty( $store_google ) || ! empty( $store_instagram ) ) : ?>
                            <ul class="list-unstyled list-inline store-social-networks <?php echo ! empty( $store_facebook ) && ! empty( $store_twitter ) && ! empty( $store_google ) && ! empty( $store_instagram ) ? esc_attr( 'all-active' ) : ''; ?>">
								<?php
                        ...
                        <div class="white-block-content shop-offer-filter">
							...
							<?php if ( $theme_usage == 'all' ): ?>
                                <a href="<?php the_permalink() ?>" class="<?php echo empty( $offer_type ) ? 'active' : '' ?>"><?php _e( 'All ', 'couponxl' ) ?>(<?php echo esc_html( $deals + $coupons ); ?>)</a>
							<?php endif; ?>
							<?php if ( $theme_usage == 'deals' || $theme_usage == 'all' ): ?>
                                <a href="<?php echo couponxl_append_query_string( '', array( 'offer_type' => 'deal' ), array( 'store' ) ); ?>" class="<?php echo 'deal' == $offer_type ? 'active' : '' ?>"><?php _e( 'Deals ', 'couponxl' ) ?>(<?php echo esc_html( $deals ); ?>)</a>
							<?php endif; ?>
							<?php if ( $theme_usage == 'coupons' || $theme_usage == 'all' ): ?>
                                <a href="<?php echo couponxl_append_query_string( '', array( 'offer_type' => 'coupon' ), array( 'store' ) ); ?>" class="<?php echo 'coupon' == $offer_type ? 'active' : '' ?>"><?php _e( 'Coupons ', 'couponxl' ) ?>(<?php echo esc_html( $coupons ); ?>)</a>
							<?php endif; ?>
                        </div>
                ...
                <div class="col-md-9">
					...
					global $wp;
                                        ...
                                        $urllist = explode("/",$current_url);

                                        if(isset($urllist[7]) && $urllist[7] > 1){
                                                $cur_page = $urllist[7];
                                        }
                                        else{
