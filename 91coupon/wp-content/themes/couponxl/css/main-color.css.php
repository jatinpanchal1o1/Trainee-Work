...
.site-logo{
	padding: <?php echo esc_attr( $site_logo_padding ); ?>;
}

.nav.navbar-nav{
    padding: <?php echo esc_attr( $site_navigation_padding ); ?>;
}
...
.home-page-body{
	<?php if( !empty( $home_page_bg_image['url'] ) ): ?>
		background-image: url( <?php echo esc_attr( $home_page_bg_image['url'] ) ?> );
	<?php endif; ?>
	background-repeat: <?php echo esc_attr( $home_page_bg_image_repeat ); ?>;
	background-size: <?php echo esc_attr( $home_page_bg_image_size ); ?>;
}

.home-page-title h1, .home-page-title h5{
	color: <?php echo esc_attr( $home_page_main_title_font_color ); ?>;
}

.page-title{
	background-color: <?php echo esc_attr( $page_title_bg_color ) ?>;
	<?php if( !empty( esc_attr( $page_title_bg_image['url'] ) ) ): ?>
		background-image: url( <?php echo esc_attr( $page_title_bg_image['url'] ); ?> );
	<?php endif; ?>
	background-repeat: <?php echo esc_attr( $page_title_bg_image_repeat ); ?>;
	background-size: <?php echo esc_attr( $page_title_bg_image_size ); ?>;
}

.page-title h1, .page-title h2, .page-title h3, .page-title h4, .page-title h5, .page-title p{
	color: <?php echo esc_attr( $page_title_font_color ); ?>;
}
...
.coupon-code-modal.print {
    border-color: <?php echo esc_attr( $button_light_green_font_color ); ?>;
}
...
.widget_couponxl_filter ul li.active.current:before{
    background-color: <?php echo esc_attr( $button_light_green_bg_color ); ?>;
    color: <?php echo esc_attr( $button_light_green_font_color ); ?>;
}
...
.widget_couponxl_filter .show-all a:hover{
    color: <?php echo esc_attr( $button_light_green_bg_color ); ?>;
}
...
.white-block-content a.btn:hover{
    background-color: <?php echo esc_attr( $button_light_green_bg_color_hvr ); ?>;
    color: <?php echo esc_attr( $button_light_green_font_color_hvr ); ?>;
}
...
.widget_couponxl_custom_stores .white-block-content div:hover a i
{
    ...
    color: <?php echo esc_attr( $main_color_font ); ?>;
}
...
section .home-page-search-box .input-group input.form-control {
    background-color: <?php echo esc_attr( $home_page_search_input_bg_color ); ?>;
	border-color: rgba( <?php echo esc_attr( couponxl_hex2rgb( $home_page_search_input_border_color ) ); ?>, .2 );
	color: <?php echo esc_attr( $home_page_search_input_font_color ); ?>;
}

/* Background on Focus */
section .home-page-search-box .input-group input.form-control:focus {
    background-color: <?php echo esc_attr( $home_page_search_input_bg_color_focus ) ?>;
	border-color: rgba( <?php echo esc_attr( couponxl_hex2rgb( $home_page_search_input_border_color_focus ) ); ?>, .2 );
	color: <?php echo esc_attr( $home_page_search_input_font_color_focus ); ?>;
}
...
section .home-page-search-box .input-group input.form-control:focus:-ms-input-placeholder{
    color: <?php echo esc_attr( $home_page_search_input_placeholder_color ); ?>;
}


/* Dropdown Background */
.home-page-search-box .search_options ul li a {
    background-color: <?php echo esc_attr( $home_page_search_dropdown_bg_color ); ?>;
    border-color: <?php echo esc_attr( $home_page_search_dropdown_bg_color ); ?>;
    color: <?php echo esc_attr( $home_page_search_dropdown_font_color ); ?>;
}

/* Dropdown Background On Hover*/
.home-page-search-box .search_options ul li a:hover {
    background-color: <?php echo esc_attr( $home_page_search_dropdown_bg_color_hvr ); ?>;
    border-color: <?php echo esc_attr( $home_page_search_dropdown_bg_color_hvr ); ?>;
    color: <?php echo esc_attr( $home_page_search_dropdown_font_color_hvr ); ?>;
}

/* Breadcrumbs Background */
.breadcrumb-section,
.breadcrumb {
    background-color: <?php echo esc_attr( $breadcrumbs_bg_color ); ?>;
    color: <?php echo esc_attr( $breadcrumbs_font_color ); ?>;
}

/* Breadcrumb Font */
.breadcrumb-section .breadcrumb li a {
    color: <?php echo esc_attr( $breadcrumbs_link_font_color ); ?>;
}
/* Breadcrumb Font on Hover */
.breadcrumb-section .breadcrumb li a:hover {
    color: <?php echo esc_attr( $breadcrumbs_link_font_color_hvr ); ?>;
}
...
.navbar-nav ul li.current-menu-item > a{
    font-family: "<?php echo esc_attr( $navigation_font ); ?>", sans-serif;
}
...
.coupon-code-modal,
.coupon-code-modal.print{
    font-family: "<?php echo esc_attr( $titles_font ); ?>", sans-serif;
}

.notification-bar{
    background: <?php echo esc_attr( $notification_bg_color ); ?>;
    color: <?php echo esc_attr( $notification_font_color ); ?>;
}
