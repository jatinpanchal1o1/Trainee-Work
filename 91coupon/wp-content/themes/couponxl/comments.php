				...
				<?php
					$comments_args = array(
						...
						'comment_field'	=>	'<div class="input-group">
												<textarea class="form-control" placeholder="'.esc_attr__( 'COMMENT', 'couponxl' ).'" name="comment"></textarea>
        									</div>',
						'cancel_reply_link' => __( 'or cancel reply', 'couponxl' ),
						'comment_notes_after' => '',
						'comment_notes_before' => '',
						'must_log_in' => '<p class="must-log-in">' .  sprintf( __( 'You must be <a href="%s">logged in</a> to post a comment.', 'couponxl' ), couponxl_get_permalink_by_tpl( 'page-tpl_login' ) ) . '</p>'
					);
