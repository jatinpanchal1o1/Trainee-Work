...
<section>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-block demo-notice"><?php _e( 'This is demo. Image uploading and offer submitting is not possible.','couponxl' ); ?></div>
            </div>
        </div>
	    <?php endif; ?>
                		...
                		<div class="row">
                			<div class="col-sm-4">
                				<ul class="list-unstyled">
                					...
                					<li class="<?php echo 'edit_profile' == $subpage ? 'active' : '' ?>">
                					...
                					<li class="<?php echo 'mu_purchases' == $subpage ? 'active' : '' ?>">
                                    ...
                                    <?php if( $theme_usage == 'all' || $theme_usage == 'coupons' ): ?>
                    					<li class="<?php echo 'my_coupons' == $subpage ? 'active' : '' ?>">
                                    ...
                                    <?php if( $theme_usage == 'all' || $theme_usage == 'deals' ): ?>
                    					<li class="<?php echo 'my_deals' == $subpage ? 'active' : '' ?>">
