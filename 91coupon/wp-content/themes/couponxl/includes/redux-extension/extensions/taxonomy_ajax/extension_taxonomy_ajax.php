...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_taxonomy_ajax' ) ) {


    /**
     * Main ReduxFramework taxonomy_ajax extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_extension_taxonomy_ajax extends ReduxFramework {
        ...
        */
        public function __construct( $parent ) {
            ...
            add_action('wp_ajax_taxonomy_ajax_ac', array( &$this, 'taxonomy_ajax_action' ));
