	...
	class CouponXL_Options {
		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						'id'       => 'geolocation',
						'type'     => 'select',
						'title'    => __( 'Enable Geolocation', 'couponxl' ),
						'options'  => array(
							0 => __( 'Disable', 'couponxl' ),
							1 => __( 'Enable', 'couponxl' )
						),
						'default'  => 0,
						'compiler' => 'true',
						'desc'     => __( 'Assign initial/starting location for website so when visitors visit website they will see deals & coupons from default location.', 'couponxl' )
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						'id'       => 'footer_instagram',
						'type'     => 'text',
						'title'    => __( 'Instagram', 'couponxl' ),
						'compiler' => 'true',
						'desc'     => __( 'Input link to your instagram page', 'couponxl' )
					),
				)
			);
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						'id'    => 'unit_separator',
						'title' => __( 'Unit Thousands Separator', 'couponxl' ),
						'desc'  => __( 'Select unit thousands separator', 'couponxl' ),
						'type'  => 'text',
					),
					array(
						'id'    => 'paypal_username',
			...
			// Google API //
			$this->sections[] = array(
				'title'      => __( 'Google API', 'couponxl' ),
				'desc'       => __( 'Google API Settings.', 'couponxl' ),
				'icon'       => '',
				'subsection' => true,
				'fields'     => array(
					//Username
					array(
						'id'    => 'google-api',
						'type'  => 'text',
						'title' => __( 'Google API key', 'couponxl' ),
						'desc'  => sprintf( __( 'Input your google api key. %s', 'couponxl' ), '<a target="_blank" href="' . esc_url( 'https://developers.google.com/maps/documentation/javascript/get-api-key' ) . '">Get Google API key</a>' )
					),
				)
			);
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'menu_title'           => __( 'CouponXL', 'couponxl' ),
				'page_title'           => __( 'CouponXL', 'couponxl' ),
