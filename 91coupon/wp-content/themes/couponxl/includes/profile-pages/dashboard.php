<div class="dashboard-info">
	<h6><?php _e( 'Hi ', 'couponxl' ) ?><strong><?php echo esc_html( $current_user->display_name ); ?></strong><?php _e( ' here\'s quick overview of your stats.', 'couponxl' ); ?></h6>
	<?php
	...
	<ul class="list-unstyled">
		<?php if( $theme_usage == 'all' || $theme_usage == 'coupons' ): ?>
			<li>
				<i class="fa fa-tags"></i> <?php _e( 'Coupons: ', 'couponxl' ); ?> <span class="badge"><?php echo esc_html( $count_coupons );  ?></span>
			</li>
		<?php endif; ?>
		<?php if( $theme_usage == 'all' || $theme_usage == 'deals' ): ?>
			<li>
				<i class="fa fa-hand-o-right"></i> <?php _e( 'Deals: ', 'couponxl' );  ?> <span class="badge"><?php echo esc_html( $count_deals ); ?></span>
			</li>
		<?php endif; ?>
		<li>
			<i class="fa fa-bar-chart"></i> <?php _e( 'Sales: ', 'couponxl' ); ?> <span class="badge"><?php echo esc_html( $earnings['sales'] ); ?></span>
		</li>
		<li>
			<i class="fa fa-shopping-cart"></i> <?php _e( 'Purchases: ', 'couponxl' ); ?> <span class="badge"><?php echo esc_html( $count_purchases ); ?></span>
		</li>
