		...
		if ( $purchases->have_posts() ) {
			...
			while ( $purchases->have_posts() ) {
                ...
                <tr>
                    ...
                    <td>
						<?php $voucher_code = get_post_meta( get_the_ID(), 'voucher_code', true );
						echo esc_html( $voucher_code ); ?>
                    </td>
                    <td>
						<?php
                    ...
                    <td>
                        ...
                        <ul class="voucher-print list-unstyled">
                            <li>
                                ...
                                <br/>
                                <span><?php echo esc_html( $voucher_code ); ?></span></li>
                            <li>
								<?php _e( 'Voucher For Deal: ', 'couponxl' ); ?>
                                <br/>
                                <span><?php echo esc_html( $deal->post_title ); ?></span>
                            </li>
							<?php
							if ( ! empty( $expire_date ) ):
                                ...
                                <li>
                                    ...
                                    <span><?php echo esc_html( $expire_date ); ?></span>
                                </li>
							<?php endif;
							?>
							<?php
							...
							if ( ! empty( $deal_in_short ) ):
                                ...
                                <li>
                                    ...
                                    <span><?php echo esc_html( $deal_in_short ); ?></span>
                                </li>
							<?php endif;
							?>
							<?php $offer_store = get_post_meta( $deal->ID, 'offer_store', true ); ?>
							<?php $store = get_post( $offer_store ); ?>
							<?php $author = get_userdata( $store->post_author ); ?>
                            <li>
								<?php _e( 'Email: ', 'couponxl' ); ?>
                                <br/>
                                <span><?php echo esc_html( $author->user_email ); ?></span>
                            </li>
							<?php $phone = get_user_meta( $author->ID, 'phone_number', true ); ?>
							<?php if ( ! empty( $phone ) ) : ?>
                                <li>
									<?php _e( 'Phone: ', 'couponxl' ); ?>
                                    <br/>
