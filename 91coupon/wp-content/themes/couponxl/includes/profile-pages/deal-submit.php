...
<div>
    ...
    <div class="input-group">
        ...
        <textarea type="text" name="deal_in_short" id="deal_in_short" class="form-control" data-validation="required" data-error="<?php esc_attr_e( 'Please input deal in short', 'couponxl' ); ?>"><?php echo wp_kses_post( $deal_in_short ); ?></textarea>
...
<div>
    ...
    <div class="input-group">
        ...
        <select name="deal_type" id="deal_type" class="form-control" data-validation="required" data-error="<?php esc_attr_e( 'Select deal type', 'couponxl' ); ?>" data-shared="<?php echo couponxl_get_option( 'deal_owner_price_shared' ) ?>" data-not_shared="<?php echo couponxl_get_option( 'deal_owner_price_not_shared' ) ?>" data-unit="<?php echo couponxl_get_option( 'unit' ) ?>" data-unit_position="<?php echo couponxl_get_option( 'unit_position' ) ?>">
            ...
            <option value="shared" <?php echo 'shared' == $deal_type ? 'selected="selected"' : ''; ?>><?php _e( 'Website Offer', 'couponxl' ) ?></option>
            <option value="not_shared" <?php echo 'not_shared' == $deal_type ? 'selected="selected"' : ''; ?>><?php _e( 'Store Offer', 'couponxl' ) ?></option>
        </select>
