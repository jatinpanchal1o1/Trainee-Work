    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="input-group">
	            ...
	            <?php if( pbs_is_demo() ) :?>
                    <a href="javascript:" class="image-upload"><?php _e( 'Change Avatar', 'couponxl' ); ?></a>
	            <?php else: ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php if( !empty( $paypal_username ) ): ?>
                <div class="input-group paypal" style="<?php echo 'paypal' == $seller_payout_method ? '' : 'display: none;'; ?>">
            ...
            <?php if( !empty( $skrill_api_mqi_password ) ): ?>
                <div class="input-group skrill" style="<?php echo 'skrill' == $seller_payout_method ? '' : 'display: none;'; ?>">
            ...
            <?php if( !empty( $ap_client_id ) ): ?>
                <div class="input-group stripe" style="<?php echo 'stripe' == $seller_payout_method ? '' : 'display: none;'; ?>">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="input-group">
                ...
                <textarea name="description" id="description"><?php echo wp_specialchars_decode( $description ); ?></textarea>
            </div>        	

            <input type="hidden" value="1" name="update_profile" />
            <a href="javascript:" class="btn <?php echo pbs_is_demo() ? '' : esc_attr( 'submit-form' ); ?>">
