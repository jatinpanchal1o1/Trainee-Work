...
?>	
	...
	<form method="POST" action="<?php echo esc_url( couponxl_append_query_string( $permalink, array( 'subpage' => $subpage, 'action' => 'add' ), array( 'all' ) ) ) ?>" enctype="multipart/form-data">
		<div id="wizard" class="<?php echo 'coupon' == $type ? 'coupon-wizard' : '' ?>">
		    <h1></h1>
		    <div>
			    ...
			    <div class="input-group">
				    ...
				    <?php if( pbs_is_demo() ) :?>
                        <input type="hidden" name="offer_featured_image" id="offer_featured_image" value="<?php esc_attr( $offer_featured_image ) ?>" data-error="<?php esc_attr_e( 'Please input offer presentation image', 'couponxl' ); ?>">
	                <?php else: ?>
			        ...
			        <a href="javascript:" class="image-upload <?php echo pbs_is_demo() ? '' : esc_attr( 'featured-image' ); ?>"><?php _e( 'Select featured image', 'couponxl' ) ?></a>
			...
			<div>
			    ...
			    <div class="input-group">
			        ...
			        <textarea name="offer_new_store" id="offer_new_store" class="form-control" ><?php echo wp_kses_post( $offer_new_store ); ?></textarea>
			    ...
			    <div class="input-group">
			        ...
			        <textarea name="offer_new_category" id="offer_new_category" class="form-control" ><?php echo wp_kses_post( $offer_new_category ); ?></textarea>
			    ...
			    <div class="input-group">
			        ...
			        <textarea name="offer_new_location" id="offer_new_location" class="form-control" ><?php echo wp_kses_post( $offer_new_location ); ?></textarea>
