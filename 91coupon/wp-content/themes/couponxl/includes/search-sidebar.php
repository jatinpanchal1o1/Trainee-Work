<div class="col-md-3">
    <div class="widget white-block widget_couponxl_filter">
        ...
        ?>
            ...
            ?>
                <div class="widget-title">
                    <h4>
                        <?php echo esc_html( $search_page_offer_type_filter_title ); ?>
                    </h4>
                </div>
            <?php endif; ?>
        ...
        ?>
            <div class="widget-title">
                <h4>
                    <?php echo esc_html( $search_page_category_filter_title ); ?>
                </h4>
            </div>
        <?php endif; ?>
        ...
        ?>                    
            <div class="widget-title">
                <h4>
                    <?php echo esc_html( $search_page_location_filter_title ); ?>
                </h4>
            </div>
        <?php endif; ?>
